---
number: 15
title: "Of Other Lawes of Nature"
part: "Of Man"
footnotes:
  - after: "Cokes Commentaries on Litleton"
    text: "[**Sir Edward Coke**](https://en.wikipedia.org/wiki/Edward_Coke) (1552-1634), Lord Chief Justice and the foremost authority on English common law. *Litleton* is Sir Thomas Littleton (c. 1407-1481), whose treatise on tenures Coke's commentary was built upon; the two together were the standard text for English lawyers. Hobbes takes Coke on at length in [Chapter 26](/chapters/26-of-civill-lawes/). [Listed among the people Hobbes names](/thinkers/#contemporaries-and-near-contemporaries)."
note: "The nineteen laws of nature, each with its own marginal heading. They are not commands but rather theorems about what a rational creature would want, and the notes in the margin mark the places where a law answers somebody: the Foole, [Aristotle](/interlocutors/aristotle/), or the reader who wonders why any of it binds before there is a sovereign."
marginalia:
  - heading: "The Third Law Of Nature, Justice"
    label: "That men performe their Covenants made — the law the sovereign exists to enforce"
    href: "/concepts/contract/"
  - heading: "Justice And Injustice What"
    label: "There is no injustice until there is a covenant to break"
    href: "/concepts/contract/"
  - heading: "Justice Not Contrary To Reason"
    label: "The answer to the Foole, who says in his heart there is no such thing as justice"
    href: "/themes/contractarianism/"
  - heading: "Justice Commutative, And Distributive"
    label: "Aristotle's two kinds of justice, both redefined out of recognition"
    href: "/interlocutors/aristotle/#rejecting-aristotles-politics"
  - heading: "The Seventh, That In Revenges, Men Respect Onely The Future Good"
    label: "Punishment looks forward; the definition is set out in Chapter 28"
    href: "/chapters/28-of-punishments-and-rewards/"
  - heading: "The Ninth, Against Pride"
    label: "Against Aristotle's natural slavery: every man acknowledge other for his equall"
    href: "/interlocutors/aristotle/#rejecting-aristotles-politics"
  - heading: "The Lawes Of Nature Oblige In Conscience Alwayes,"
    label: "In foro interno they always bind; to performance, only where it is safe"
    href: "/themes/law/#the-law-of-nations"
  - heading: "The Science Of These Lawes, Is The True Morall Philosophy"
    label: "Moral philosophy as the science of good and evil, which are names"
    href: "/concepts/good-and-evil/"
---
