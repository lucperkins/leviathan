...
/**
 * Primary-text pages: attaches a short note to a marginal heading, shown in
 * the right margin where there is room for it and inline underneath where
 * there is not. Driven by the unit's `marginalia` frontmatter:
 *
 *   marginalia:
 ...
 */
export default function rehypeMarginalia({ textCollection }) {
